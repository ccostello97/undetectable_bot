...
const plugins = [
    { name: 'Chrome PDF Plugin', description: 'Portable Document Format', filename: 'internal-pdf-viewer', mimeTypes: [mimeTypes[0]] },
    { name: 'Chrome PDF Viewer', description: '', filename: 'mhjfbmdgcfjbbpaeojofohoefgiehjai', mimeTypes: [mimeTypes[1]] },
    { name: 'Native Client', description: '', filename: 'internal-nacl-plugin', mimeTypes: [mimeTypes[2], mimeTypes[3]] }
].map(p => {
...
Object.defineProperties(pluginArray, {
    ...
    item: { value: function (index) { return this[index]; } },
    namedItem: { value: function (name) { return this[name]; } },
...
HTMLCanvasElement.prototype.getContext = function (contextType, contextAttributes) {
    ...
    const context = getContextProto.call(this, contextType, { ...defaultAttributes, ...contextAttributes });
